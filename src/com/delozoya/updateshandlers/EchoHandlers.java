...
public class EchoHandlers extends TelegramLongPollingBot {
    ...
    private void handleEcho(Update update) throws InvalidObjectException {
        ...
        if (message.getText().startsWith(Commands.startCommand)) {
            ...
            sendMessageRequest.setChatId(message.getChatId().toString());
            try {
                sendMessageRequest.setText(Pilotos.getPiloto("Nico"));
            } catch (SQLException e) {
                e.printStackTrace();
            }
            SendPhoto image = new SendPhoto();
            image.setNewPhoto("C:\\Nico.png","Nico.png");
        ...
        }else if(message.getText().startsWith(Commands.startservice)){
            System.out.println(message.getText());
            try {
        ...
        }else if (message.getText().equals("Horario")){
            System.out.println("jeje1");
        }else if (message.getText().equals("Tiempo")) {
